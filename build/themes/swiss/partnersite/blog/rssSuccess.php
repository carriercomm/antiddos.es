<<?php echo '?' ?>xml version="1.0" encoding="utf-8"<?php echo '?' ?>>
    <rss version="2.0">
        <channel>
            ...
            <link><?php echo $site->getUrl()?>/<?php echo $sf_user->getCulture()?>/blog/rss.xml</link>
          ...
          <?php foreach ($posts as $item):?>
            <item>
                ...
                <link><?php echo $site->getUrl()?>/<?php echo $sf_user->getCulture()?>/blog/<?php echo $item->getId()?></link>
