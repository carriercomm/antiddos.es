<?php $sf_response->addMeta("title", __("BitTorrent Sync Servers %site%", array('%site%'=>sfConfig::get('app_site_name')))) ?>
<?php $sf_response->addMeta("keywords", "Cloud,Cloud Server,Linux,Windows,Instant, Server Hosting,Swiss,Schweiz,Switzerland,root server,Server Hosting,DDoS Protection,Performance, SATA, SAS, Intel") ?>
<?php $sf_response->addMeta("description", __("%site% offers wide range of Cloud hosting configurations hosted in Switzerland, Zurich. Fastest Network. Instant Setup. 15 TB bandwidth included.", array('%site%'=>sfConfig::get('app_site_name')))) ?>
...
<div class="content">
<h3 style="font-size: 22px; height: 30px; line-height: 30px;"><?php t('sync_title1')?></h3>
<div class="sync b1"><?php t('sync_block1',array('%site%'=>$site->getName())) ?></div>


<h3><?php t('sync_title2')?></h3>
<div class="sync b2"><?php t('sync_block2',array('%site%'=>$site->getName())) ?>
<div style="margin-top: 6px;"><a class="minic" href="http://labs.bittorrent.com/experiments/sync/technology.html">http://labs.bittorrent.com/experiments/sync/technology.html</a></div>
</div>

<h3><?php t('sync_title3')?></h3>
<div class="sync b3"><?php t('sync_block3',array('%site%'=>$site->getName())) ?></div>

<table border="0" cellpadding="0" cellspacing="0" width=100%><tr><td width=40%>
<h3><?php t('sync_title5')?></h3>
<div class="sync b5"><?php t('sync_block5',array('%site%'=>$site->getName())) ?></div>

</td><td width=10> </td><td>
<h3><?php t('sync_title4')?></h3>
<div class="sync b4"><?php t('sync_block4',array('%site%'=>$site->getName())) ?></div>

</td></tr></table>

<h3><?php t('sync_title6')?></h3>
<div class="sync b6"><?php t('sync_block6',array('%site%'=>$site->getName())) ?></div>
