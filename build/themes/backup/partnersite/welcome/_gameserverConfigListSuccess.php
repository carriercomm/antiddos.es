			...
			<!-- Block table minecraft-->
								<div class="block minecraft-table">
										<table>
												<thead>
														<tr>
																						<th class="name" width="120"><?php t('Game Server')?></th>
...
<th class="price" width="190">Price per month</th>
								...
								<div  id="top_ahchor" class="block minecraft">
										<div class="minecraft-container">
																<div class="minecraft content-group">
																		...
																		Cloudcom offer affordable Dedicated Servers for gaming with DDoS Protection included. We use Intel Xeon processors, SSD hard drives, 1 gigabit lan ports and top server hardware by Supermicro, Cisco and Juniper in order to provide the best ddos protected game server hosting possible. Enjoy your Dedicated Game Server with DDoS Protection by Cloudcom.<br>
																		...
																		<div class="item-content minecraft-2">												
																				...
																				<div class="description">All of our Dedicated Game Servers are great for Minecraft lovers. Since our start we have hosted hundreds of servers for Minecraft Server owners, providing best DDoS Protection along with Minecraft-ready servers for free. All of our Minecraft server owners are happy and completely satisfied by our service. We guarantee your complete Minecraft satifaction with our Gamma S or Magma Servers or get your money back!
																		...
																		<div class="item-content minecraft-4">
																				...
																				<div class="description">
																				 Cloudcom offer top of the line hardware for your Counter Strike server. We offer Quad-core and Six-core processors, Solid-State or SAS Hard Drives and Supermicro servers with top of the line hardware in order to manage your server remotely. We also install the OS of your choice, the setup is completely free. And of course, the 10 gigabit ddos protection included with every Dedicated Server. 
																				<a href="<?php echo url_for('@show_page?name=hardware-features') ?>" class="more"><?php t('Read more...')?></a>	
																				</div>
																		</div>
										...
										<div class="block main-bottom-block-img">
												...
												<div class="second-img link">
														<div class="description">
																...
																<div class="text"> Minecraft and other games can be perfectly fit on Dedicated Servers by Cloudcom, hosted in Europe, with 10 GB ddos protection included. ?>
 																</div>
																<div class="border-item"></div>
														</div>
												</div>
												<div class="third-img link">
														<div class="description">
																...
																<div class="text">Manage your online game server business with all mods you need - Our servers support all kinds of multiplayer game server mods and work flawlessly without glitches or downtimes! 
</div>
																<div class="border-item"></div>
														</div>
												</div>
