<div class="title price"><?php t('Pay with a %app%', array('%app%'=>'PayPal')) ?></div>
<div class="content">
    <form method="post">
        <table width="100%" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td><?php t('You will be redirected to %app% site.', array('%app%'=>'PayPal')) ?></td>
            </tr>
            </tbody>
        </table>
        <br/>
        ...
        <table width="100%">
            ...
            <tr>
                <td align="left">
                    <a class="zbutton" href="<?php echo url_for('@back?id=' . $invoice->getId()) ?>"><?php t('Back')?></a>
                </td>
                <td align="right">
