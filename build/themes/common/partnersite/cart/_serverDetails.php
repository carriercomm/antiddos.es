...
<Table border=0 cellpadding="0" cellspacing="0" width=100%><tr><td valign=top class="productinfo">
      ...
      <table width=100% cellpadding="0" cellspacing="2" border=0>
        ...
        <tr><td class="his s1"><?php t('DDos protection')?>:</td><td class="his s2" id="ddos_protection"><?php echo ( ($text_new == true && $product->getOnlyEco() ) || ( $text_new == false && $order->getEco() ) ) ? 'Disabled' : 'Enabled 10 gb/s - 4mpps' ?></td></tr>
