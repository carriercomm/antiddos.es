  <td width=42><img src="<?php echo solar_image_url('minicolo.png') ?>" width=42></td>
  <td align=left ><b><?php t('Colocation')?></b><br><?php echo link_to(__($order->isItemAssigned() ? $order->item['name'] : 'N/A'), '@order_show?id=' . $order->id, 'class="link"') ?></td>
