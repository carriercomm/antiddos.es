  ...
  <td width=32><img src="<?php echo solar_image_url('camfrog_mini.png') ?>" width=32></td>
  <td align=left><b><?php t('Camfrog Room Hosting')?></b><br><?php echo link_to(__($order->isItemAssigned() ? $order->item['name'] : 'N/A'), '@order_show?id=' . $order->id, 'class="link"') ?></td>
